...
export default function Megaphone3D({ position = [0, 0, 0], scale = 1 }) {
  ...
  return (
    <group ref={groupRef} position={position} scale={scale}>
      {/* 3D Floating Megaphone Artwork Container */}
      <Html
        transform
        distanceFactor={5.2}
        position={[0, 0, 0]}
      ...
      >
        ...
        >
          {/* Ambient Orange/Blue Digital Marketing Stage Glow */}
          <div
            style={{
              position: 'absolute',
              bottom: '0%',
          ...
          <img
            src={megaphoneImg}
            alt="Orbitone Digital Marketing Megaphone Engine"
            style={{
              width: '100%',
              height: 'auto',
              display: 'block',
